...
export default function BookStorePage() {
  ...
  return (
    <div className="w-full min-h-screen px-4 sm:px-12 py-8 pb-32 max-w-7xl mx-auto selection:bg-stone-200 dark:selection:bg-zinc-800">
      ...
      {/* 🔮 Header Section */}
      <header className="flex justify-between items-center py-6 border-b border-stone-200 dark:border-zinc-800 transition-colors gap-4">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-3.5 py-2 rounded-full border border-stone-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hover:bg-stone-100 dark:hover:bg-zinc-800 text-stone-700 dark:text-zinc-300 text-xs font-mono tracking-tight transition-all flex items-center gap-1.5 shadow-sm"
          >
          ...
          <div className="w-full max-w-md bg-white dark:bg-zinc-900 h-full p-6 flex flex-col justify-between shadow-2xl animate-in slide-in-from-right duration-300">
            <div>
              <div className="flex justify-between items-center pb-4 border-b border-stone-200 dark:border-zinc-800">
                ...
                <button onClick={() => setIsCartOpen(false)} className="text-stone-400 hover:text-stone-900 dark:hover:text-zinc-100">
                  ✕
                </button>
              </div>
                  ...
                  cartItems.map(({ book, quantity }) => (
                    <div key={book.id} className="flex gap-4 items-center justify-between border-b border-stone-100 dark:border-zinc-800/50 pb-3">
                      ...
                      <div className="flex items-center gap-2 bg-stone-100 dark:bg-zinc-800 px-2 py-1 rounded-full">
                        <button onClick={() => updateQuantity(book.id, -1)} className="text-xs px-1 text-stone-500 hover:text-stone-900 dark:hover:text-zinc-100 font-bold">-</button>
